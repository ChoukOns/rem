...
*/
  ...
  const Sidebar = () => {
    ...
    return (
      <div className="sidebar2">
        ...
        <FontAwesomeIcon icon={faUser} /> {t('Mon profil')}
  </div><br />
  ...
  const showEditButton = (row, index) => (
    <button className="btn-modifier" data-toggle="tooltip" data-placement="top" title="Mdofier" onClick={() => editFile(row, index)}>
...
useEffect(() => {
  ...
  return (
    <div className="application-container">
      ...
      <div className="main-content">
        ...
        {option1 === 'statistique' && (
    <div>
      <h1 className="taille"><center>{t('Satistiques des ventes')}</center></h1>
            <br /><br />
                  ...
                  {fichiers.map((fichier, index) => (
                    <tr key={fichier.id_fichier}>
                      ...
                      <td>{fichier.langueOriginal}</td>
                       <td>
                        <button className="btn-quiz" data-toggle="tooltip" data-placement="top" title="Créer quiz" onClick={openQuizModal}>
                          <FontAwesomeIcon icon={faQuestionCircle} />
                        </button>
                      </td> 
                      <td>
                        <button className="btn-transcrire"  data-toggle="tooltip" data-placement="top" title="Visualiser" onClick={() => fetchFileByName(fichier.fileName)}>
                          <FontAwesomeIcon icon={faEye} />
                        </button>
                        &nbsp;&nbsp;
                        {showEditButton(fichier, index)} &nbsp;
                        <button className="btn-supprimer" data-toggle="tooltip" data-placement="top" title="Supprimer" onClick={() => deleteFile(fichier)}>
                          <FontAwesomeIcon icon={faTrash} />
                        </button>
                      </td>

                      <td>
                        <button className="btn-transcrire" data-toggle="tooltip" data-placement="top" title="Transcrire" onClick={() => transcribeFile(fichier.fileName, fichier.langueOriginal, fichier.id_fichier)}>
                      ...
                      <td>
                        <button className="btn-transcrire" data-toggle="tooltip" data-placement="top" title="Créer cours" onClick={() => handleOpenModal4(fichier)}>
                          <FontAwesomeIcon icon={faFileVideo} />
                        </button>
                      </td>
                    </tr>
  ...
  <input type="text" value={user?.name} readOnly />
        ...
        <div>
          {option1 === 'quiz' && (
            <div>
              <h1 className="taille"><center>{t('Les quiz')}</center></h1>
              <br /><br /><br /><br />
                ...
                {quizzes1?.map((quiz, index) => (
                  <div className="grid-item" key={quiz._id}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <div>
                        <button className="btn-supprimer" data-toggle="tooltip" data-placement="top" title="Supprimer" onClick={() => handleDeleteQuiz(quiz._id)}>
                          <FontAwesomeIcon icon={faTrash} />
                        </button> &nbsp;&nbsp;
                        <button className="btn-modifier" data-toggle="tooltip" data-placement="top" title="Modifier" onClick={() => openModal2(quiz.titre)}>
                          <FontAwesomeIcon icon={faEdit} />
                        </button>
              ...
              {selectedQuiz && selectedQuiz.questions && (
                <Modal show={true} onHide={() => setSelectedQuiz(null)}>
                  ...
                  <Modal.Footer>
                    <Button  style={{ backgroundColor: '#dc3545', color: 'white', borderColor: '#dc3545' }}
