                    ...
                    searchResults2.map((fichier) => (
                      <tr key={fichier._id}>
                        ...
                        <td>
                          ...
                          <button className="btn-supprimer" data-toggle="tooltip" data-placement="top" title="Supprimer" onClick={() => deleteFile(fichier.id_fichier)}>
                ...
                {courses.map(course => {
                  ...
                  return (
                    <tr key={course._id}>
                      ...
                      <td>
                        <button className="btn-transcrire"  
                        data-toggle="tooltip" data-placement="top" title="Visualiser"  
                        onClick={() => handleViewFile(course.fichier)}><FontAwesomeIcon icon={faEye} /></button>

                        &nbsp;&nbsp;<button className="btn-delete"  data-toggle="tooltip" data-placement="top" title="Supprimer"  onClick={() => handleDeleteCours(course._id)}>
                          <FontAwesomeIcon icon={faTrash} />
                        </button>
                        <br />
                         <a
              ...
              {quizzes?.map((quiz, index) => (
                <div className="grid-item" key={quiz._id}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <button className="btn-delete"  data-toggle="tooltip" data-placement="top" title="Supprimer" onClick={() => handleDeleteQuiz(quiz._id)}>
                      <FontAwesomeIcon icon={faTrash} />
                    </button>
                  </div>
                </div>
